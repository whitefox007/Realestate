...
type BlogPageColumnactiveProps = Omit<
  React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>,
  "business" | "p10delightfuldinone" | "july202022" | "time" | "active"
> &
  Partial<{
    business: string;
    p10delightfuldinone: string;
    july202022: string;
    time: string;
    active: string;
  }>;

const BlogPageColumnactive: React.FC<BlogPageColumnactiveProps> = (props) => {
  return (
    <>
